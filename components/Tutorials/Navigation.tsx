...
export const Navigation = ({
  ...
  return (
    ...
    >
      <div className="sticky md:hidden top-0 mb-8 mr-8 pr-8 bg-white dark:bg-neutral-900 border-b">
      ...
      <div className="hidden p-2 overflow-x-auto md:block border-r mr-8 h-full animate-fade-in flex-col justify-center items-start">
        {children}
      </div>
    </NavigationTreeContext.Provider>
  );
